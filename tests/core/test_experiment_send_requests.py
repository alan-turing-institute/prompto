...
# @pytest.mark.asyncio
# async def test_send_requests_retry(temporary_data_folder_for_processing, caplog):
#     caplog.set_level(logging.INFO)
#     settings = Settings(data_folder="data")
#     experiment = Experiment("test_experiment.jsonl", settings=settings)
#     create_folder(experiment.output_folder)

#     result = await experiment.send_requests_retry(prompt_dicts=[], attempt=1, rate_limit=10)


# @pytest.mark.asyncio
# async def test_send_requests_retry_with_group(temporary_data_folder_for_processing, caplog):
#     caplog.set_level(logging.INFO)
#     settings = Settings(data_folder="data")
#     experiment = Experiment("test_experiment.jsonl", settings=settings)
#     create_folder(experiment.output_folder)

#     result = await experiment.send_requests_retry(prompt_dicts=[], attempt=1, rate_limit=20, group="test_group")
